  ...
  return (
    <ThemeProvider theme={theme}>
      ...
      >
        <Toolbar>
          <img
            src="https://images.unsplash.com/photo-1615461066159-fea0960485d5?q=80&w=2516&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
            alt="Logo"
            style={{
              width: 40,
              height: 40,
